...
class NationsCLI:
    ...
    def __init__(self, player_names, seed=None, replay=None, quit_after_replay=False, verbose=True):
        self.verbose = verbose
        self.quit_after_replay = quit_after_replay
        logger = self.logger if verbose else None
        self.match = match.Match(player_names=player_names, seed=seed, replay=replay, move_getter=self.get_move_prompt, logger=logger)
